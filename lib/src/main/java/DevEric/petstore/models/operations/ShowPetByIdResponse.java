...
public class ShowPetByIdResponse {
    ...
    public DevEric.petstore.models.shared.Error error;

    public ShowPetByIdResponse withError(DevEric.petstore.models.shared.Error error) {
        this.error = error;
        return this;
    }
    ...
    public DevEric.petstore.models.shared.Pet pet;

    public ShowPetByIdResponse withPet(DevEric.petstore.models.shared.Pet pet) {
        this.pet = pet;
        return this;
    }
